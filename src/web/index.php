...
if (isset($_GET['filter_by_first_letter']))
{
    ...
    $airports = filterByFirstLetter($airports, $letter);
}

if (isset($_GET['filter_by_state']))
{
    $state = $_GET['filter_by_state'];
    $airports = filterByState($airports, $state);
}
...
{
    pagination($airports, $currentPage, $pagesNumber);
}
...
<main role="main" class="container">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th scope="col"><a href="/?<?php echo http_build_query(array_merge($_GET, ['sort' => 'city'])) ?>">City</a></th>
        ...
        <!--
            ...
            i.e. /?filter_by_state=Alabama or /?filter_by_state=Alaska

            Make sure, that the logic below also works:
             - when you apply filter_by_state the page should be equal 1
             - when you apply filter_by_state, then filter_by_first_letter (see Filtering task #1) is not reset
    ...
    <h3 class="text-center"><?php if (empty($airports)) :
            echo "No results that correspond to the filters you applied. <a href='/'> Please reset the filters</a>";
        endif; ?></h3>
    <!--
        Pagination task
